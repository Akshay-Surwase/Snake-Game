...
s.bgcolor("lightblue")
s.setup(height=700, width=700)  # creating a size of a screen
...
head.color("blue")
head.fillcolor("red")
head.penup()  # it hides the line which display when head goes to another place
head.goto(0, 0)
head.direction = "stop"
...
food.penup()
 ...
 # it hides the line which display when food goes to another place
food.goto(150, 200)
food.st()  # it shows the food
